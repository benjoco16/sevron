<div class="tab-pane bg-light-gray" id="incidentTab3" role="tabpanel">
    <div class="row pl-3 pr-3">
        <div class="col-md-9 font-ash">
            <div class="d-flex flex-column pl-3 pr-4">
                <button class="btn btn-primary btn-xs ml-auto mt-3">
                    <small>Download Attachments</small> 
                </button>
                <button class="btn btn-primary btn-xs ml-auto mt-3">
                     <small>Add New Attachments</small>
                </button>
        ...
        <div class="col-md-3 bg-white">
            <?php include('template/incidents/incidents.quality-incident.php') ?>
